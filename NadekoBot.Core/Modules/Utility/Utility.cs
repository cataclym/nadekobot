        ...
        public async Task Stats()
        {
            ...
            await ctx.Channel.EmbedAsync(
                new EmbedBuilder().WithOkColor()
                    .WithAuthor(eab => eab.WithName($"FlanBot v{StatsService.BotVersion}")
                                          //.WithUrl("http://nadekobot.readthedocs.io/en/latest/")
                                          .WithIconUrl("https://cdn.discordapp.com/avatars/737034662047645838/35cf5d7d5fc0e4fe9dfa9a0c68869de7.png"))
